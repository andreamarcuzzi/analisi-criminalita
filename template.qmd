...
title: |
  ...
  \vfill
  \begin{center}
  {\Huge \textbf{Istruzione, Disoccupazione e Reddito: Una Valutazione Empirica del Loro Effetto sulla Criminalità}}\\[0.5cm]
...
```{r}
#carica tutti i file per il render
...
# Mostra la tabella
kable(tabella, caption = "Tabella 2 – Regressione e correlazione tra criminalità e variabili socioeconomiche")
...
ggplot(plot_data, aes(x = x, y = Criminalità)) +
  ...
  theme_minimal() +
  labs(title = "Relazione tra Criminalità e Variabili Socioeconomiche",
